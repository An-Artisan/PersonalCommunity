<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\admin\webSite\editAlbum.html";i:1492438658;s:73:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\layout.html";i:1491802852;s:80:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\common\header.html";i:1492499016;s:80:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\common\footer.html";i:1492419437;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-ico"> <img src="/static/index/head/head.jpg"></span>
                    </a>
...
<script>
        // 定义获取添加相册控制器地址
        var albumController = '<?php echo url('AlbumController/editAlbumController'); ?>';
</script>
                ...
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            <li>
                                <a href="/albumlist.html" class="active">
        ...
        <div class="tpl-content-wrapper">
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">个人网站</a></li>
                <li class="am-active">编辑相册</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 编辑相册
                    </div>
                </div>
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" id="submitForm" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    ...
                                    相册标题<span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="album_title" class="tpl-form-input" name="album_title" value="<?php echo $title; ?>" placeholder="请输入标题文字">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">相册描述 <span class="tpl-form-line-small-title">Description</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="album_desc" value="<?php echo $desc; ?>" name="album_desc" placeholder="输入相册描述">
                                    </div>
                                </div>
                               <!--  <div class="am-form-group">
 ...
 -->
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <img height="300px;" src="<?php echo $cover; ?>">
                                            </div>
                                            <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                            <i class="am-icon-cloud-upload"></i> 修改相册封面图片
                                            </button>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            ...
                                            checked="checked" 
                                            <?php endif; ?> 
                                            name="checkbox" class="ios-switch bigswitch tpl-switch-btn" />
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="album_question" value="<?php echo $question; ?>" name="album_question" placeholder="请输入问题">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">正确答案 <span class="tpl-form-line-small-title">Answer</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="album_answer" value="<?php echo $answer; ?>" name="album_answer" placeholder="请输入正确答案">
                                    </div>
                                </div>
                                </div>
                               <!--  <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="button" id="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">修改相册</button>
                                    </div>
                                </div>
