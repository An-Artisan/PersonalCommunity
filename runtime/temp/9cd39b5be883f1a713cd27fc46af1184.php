                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <?php if(is_array($seo_data) || $seo_data instanceof \think\Collection || $seo_data instanceof \think\Paginator): $i = 0; $__LIST__ = $seo_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            <td><?php echo $vo['a_id']; ?></td>
                                            <td><?php echo $vo['a_title']; ?></td>
                                            <td><?php echo $vo['a_desc']; ?></td>
                                            <td><?php echo $vo['a_keywords']; ?></td>
                                            <td><?php echo $vo['a_author']; ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        ...
                                                        <a style="text-decoration:none;color: green;" href="/editseo-<?php echo $vo['a_id']; ?>.html">编辑</a></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
