...
<script>
        // 定义获取添加相册控制器地址
        var deleteAlbumController = '<?php echo url('AlbumController/deleteAlbumController'); ?>';
</script>
<div class="tpl-page-container tpl-page-header-fixed">
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-form-group">
                                <select data-am-selected="{btnSize: 'sm'}">
                                  ...
                                  <option value="{vo.a_id}"><?php echo $vo['a_title']; ?></option>
                        ...
                        <div class="tpl-table-images">
                            ...
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
                                <div class="tpl-table-images-content">
                                    <span class="tpl-i-title">创建时间</span>
                                    <div class="tpl-table-images-content-i-time"><?php echo $vo['a_create_time']; ?></div>
                                    <div class="tpl-i-title">
                                        <?php echo $vo['a_title']; ?>
                                    </div>
                                    <a href="javascript:;" class="tpl-table-images-content-i">
                                        <span class="tpl-table-images-content-i-shadow"></span>
                                        <img height="300px;" src="<?php echo $vo['a_cover']; ?>" alt="">
                                    </a>
                                    <div class="tpl-table-images-content-block">
                                        <div class="tpl-i-font">
                                            <?php echo $vo['a_description']; ?>
                                        </div>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs tpl-edit-content-btn">
                                                <button type="button" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-edit"></span>
                                                <a style="text-decoration:none;color: #fff;" href="editalbum-<?php echo $vo['a_id']; ?>.html">编辑</a></button>
                                                <button type="button" class="am-btn am-btn-default am-btn-danger"><span a_id="<?php echo $vo['a_id']; ?>" name="delete" class="am-icon-trash-o">删除</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $("#plus_album").on("click",function(){
        layer.open({
            ...
            shade: 0.8,
            area: ['90%', '90%'],
            content: "/uploadlayer.html" //iframe的url
            }); 
    });
    </script>
