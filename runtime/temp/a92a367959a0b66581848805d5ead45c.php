...
<body style="overflow-y:scroll;" data-type="index">
  ...
  <script>
        // 定义删除留言控制器地址
        var deleteCategoryController = '<?php echo url('BlogController/deleteCategory'); ?>';
</script>
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            ...
                            <li>
                             ...
                             <li>
                               ...
                               <a href="/categorylist.html" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>分类列表</span>
                                    <i class="tpl-left-nav-content tpl-badge-success">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type">分类标签</th>
                                            <th class="table-author">分类描述</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $vo['cate_tags']; ?></td>
                                            <td><?php echo $vo['cate_description']; ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        ...
                                                        <a style="text-decoration:none;color: green;" href="/editcategory-<?php echo $vo['cate_id']; ?>.html">编辑</a></button>
                                                        <button type="button" cate_id="<?php echo $vo['cate_id']; ?>" name="delete" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>&nbsp;&nbsp;删除</button>
...
<script src="/static/admin/js/deleteCategory.js"></script>
