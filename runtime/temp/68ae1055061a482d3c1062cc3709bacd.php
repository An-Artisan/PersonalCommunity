...
<body style="overflow-y:scroll;" data-type="index">
  ...
  <script>
      ...
      var blogAddArticle = '<?php echo url('BlogController/editArticleController',["id" => $article->art_id]); ?>';
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-title" value="<?php echo $article->art_title; ?>" placeholder="标题 / Title">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" value="<?php echo $article->art_description; ?>"  id="user-desc" placeholder="描述 / Description">
                                    </div>
                                </div>
                               <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select id="category">
                                        <!-- 先输出编辑的分类 -->
                                        <option value="<?php echo $category_data[0]['cate_id']; ?>"><?php echo $category_data[0]['cate_name']; ?></option>
                                        <?php if(is_array($category_data) || $category_data instanceof \think\Collection || $category_data instanceof \think\Paginator): $i = 0; $__LIST__ = $category_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['cate_id'] != $article->cate_id): ?>
