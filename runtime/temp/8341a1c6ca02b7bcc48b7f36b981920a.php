<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\admin\blog\editCategory.html";i:1492438630;s:73:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\layout.html";i:1491802852;s:80:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\common\header.html";i:1492432105;s:80:"E:\WebRoot\PersonalCommunity\public/../application/admin\view\common\footer.html";i:1492419437;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script>
        // 定义获取添加博客分类控制器地址
        var blogController = '<?php echo url('BlogController/eidtCategoryController'); ?>';
</script>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            ...
                            <li>
                               ...
                               <a href="/addcategory.html"  class="active" >
                                    <i class="am-icon-angle-right"></i>
                                    <span>新增分类</span>
                                    <i class="tpl-left-nav-content tpl-badge-primary">
                                    </i>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" id="submitForm">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="category_title" name="category_title" class="tpl-form-input" value="<?php echo $name; ?>"  placeholder="请输入分类标题">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">分类描述 <span class="tpl-form-line-small-title">Description</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="category_desc" value="<?php echo $desc; ?>" name="category_desc" placeholder="输入分类描述">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">分类标签 <span class="tpl-form-line-small-title">TAG</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="category_tag" value="<?php echo $tags; ?>" name="category_tag" placeholder="输入分类关键字，以英文半角逗号分隔(,)">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="button" id="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">修改分类</button>
                                    </div>
                                </div>
